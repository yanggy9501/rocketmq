...
/*xxx: Broker Controller 类似 web 的 Controller */
public class BrokerController {
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            ...
            // 这个 fastRemotingServer 与 RemotingServer 功能基本差不多，处理 VIP 端口请求
